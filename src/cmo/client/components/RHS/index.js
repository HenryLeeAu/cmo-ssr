        ...
        <div className="rhs-box">
          <a href="# " className="radius hidden block">
            <img
              ...
              src="https://demo.idg.com.au/cmo/cmo50/2018/cmo50_promo2018_0813.jpg"
            />
          </a>
        </div>
        {response.rhs !== undefined && (
          <Popular {...response.rhs.sections.popular} />
        )}
        {response.rhs !== undefined && (
          <FeaturedWhitepaper {...response.rhs.sections.featuredWhitepaper} />
        )}
        {response.rhs !== undefined && (
          <WebEvents {...response.rhs.sections.webEvents} />
        )}
        <Twitter />
        <GoogleAd adSlot={17} />
      </div>
